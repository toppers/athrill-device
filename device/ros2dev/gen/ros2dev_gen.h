...
#define ROS2DEV_TOPIC_PUB_ID_NUM	1U
#define ROS2DEV_TOPIC_SUB_ID_NUM	1U

extern void (*ros2dev_topic_pub_func[ROS2DEV_TOPIC_PUB_ID_NUM]) (RosReqType *reqp);
extern void (*ros2dev_topic_sub_func[ROS2DEV_TOPIC_SUB_ID_NUM]) (RosReqType* reqp);
